        ...
        <div id="titles">
          <div class="cham">
            ...
            <div>
              <img
                id="chamimg"
                class="bigpics"
                src="../images/Beaches/champagne beach.jpg" alt ="Champagne Beach"
              />
              <img
                id="chamfood"
                class="foodpics"
                src="../images/Food/Champagne beach food.jpg" alt="Champagne beach food"
              />
            </div>
          ...
          <div class="copa" id="cb">
            ...
            <div>
              ...
              />
              <h2 id="act4" class="activities">Activities</h2>
              <div id="cbacts">
                <img
                  class="actpics2"
                ...
                />
                <img class="actpics4" src="../images/Activities/Surfing.jpg" />
              </div>
            </div>
            <img
              class="foodpics"
